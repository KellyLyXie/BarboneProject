...
const prompt = `
    ...
    - For queries comparing two or more stocks (e.g., containing words like "compare" or "and"), output each ticker separated by commas, following the rules below:
    * For dual-listed stocks, if the user's market is "US", output the US ticker (e.g. "BABA" for Alibaba).
    * For dual-listed stocks, if the user's market is "HK", output the Hong Kong ticker (e.g. "9988.HK" for Alibaba).
- For a single-stock query in Global market:
    * If the stock is dual-listed, output the ticker (US vs HK) corresponding to the higher historical stock price or market cap.
